\chapter{Good practice for writing theses}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Using the tikz library, you can also generate time plan tables. Enjoy the example!
...
\draw ($(P1)+(-2,0.5)$) node[MidnightBlue] {Project 1};
\draw ($(P2)+(-2,0.5)$) node[RedOrange] {Project 2};
\draw ($(P3)+(-2,0.5)$)  node[Plum] {Project 3};
\draw ($(P4)+(-0.5,0.5)$)  node[Dandelion] {Finish project};
%% Description
\node[fill=MidnightBlue!15,text=MidnightBlue](D1) at ($(P0)+(0,2.5)$) {
\begin{minipage}{0.25\textwidth}    \centering
\textbf{Where}\\
Do something\\
Not do something
\end{minipage}};
\node[fill=MidnightBlue!15,text=MidnightBlue](D2) at ($(P1)+(-2.5,-2.5)$) {
\begin{minipage}{0.25\textwidth}    \centering
\textbf{Where}\\
Who with you\\
Descriptions
\end{minipage}};
\node[fill=RedOrange!15,text=RedOrange](D3) at ($(P1)+(0.5,2.5)$) {
\begin{minipage}{0.25\textwidth}    \centering
\textbf{What happen}\\
Introduction\\
Potential impacts
\end{minipage}};
\node[fill=RedOrange!15,text=RedOrange](D4) at ($(P2)+(-2,-2.5)$) {
\begin{minipage}{0.25\textwidth}    \centering
\textbf{What happen}\\
Descriptions\\
Do something
\end{minipage}};
\node[fill=Plum!15,text=Plum](D5) at ($(P2)+(1,2.5)$) {
\begin{minipage}{0.25\textwidth}    \centering
\textbf{Where}\\
Project detail\\
Potential results
\end{minipage}};
\node[fill=Plum!15,text=Plum](D6) at ($(P3)+(-1,-2.5)$) {%
\begin{minipage}{0.25\textwidth}    \centering
\textbf{What happen}\\
Whom together\\
Not do something
